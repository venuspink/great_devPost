...
* [APPLYING HATEOAS TO A REST API WITH SPRING BOOT](https://www.codingame.com/playgrounds/6723/applying-hateoas-to-a-rest-api-with-spring-boot)
...
* [판다스기본사용법](https://dandyrilla.github.io/2017-08-12/pandas-10min/)
...
* [시계열분석](https://machinelearningmastery.com/time-series-datasets-for-machine-learning/)
...
* [스칼라cookbook 웹버전](https://alvinalexander.com/scala/how-to-use-if-then-expressions-guards-in-case-statements-scala)
